...
exports.build = function( total, page, pagesize, offset, length ) {
    ...
    var pageBegin = page * pagesize - pagesize;

    var pageEnd = page * pagesize  > total ? total : page * pagesize ;
...
//    console.log( "pv.step         = " + pv.step );
//	console.log( "pv.offset         = " + pv.offset );
//	console.log( "pv.length         = " + pv.length );
//    console.log( "pv.pageBegin         = " + pv.pageBegin );
//    console.log( "pv.pageEnd         = " + pv.pageEnd );
